...
/**
 * Copied from `phenopacket-tools-cli`.
 */
public class TestCases {
    ...
    public static final Phenopacket PHENOPACKET = preparePhenopacket();

    private static Phenopacket preparePhenopacket() {
     ...
     */
    private static GenomicInterpretation somaticRb1Missense() {
    ...
    private static GenomicInterpretation germlineRb1Deletion() {
    ...
    private static Biosample enucleatedEye() {
    ...
    private static MedicalAction melphalan() {
    ...
    private static MedicalAction enucleation() {
     ...
     */
    private static MedicalAction chemoRegimen() {
    ...
    private static List<PhenotypicFeature> getPhenotypicFeatures() {
